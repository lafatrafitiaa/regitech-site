...
@section('content')
 <section id="features" style="padding: 0;">
    <div class="container">
        <div class="col-md-9 ">
            <div class="heading">
                <h2 style="text-transform:none">Demande de devis pour les matériels <span>informatiques</span></h2>
                <div class="line"></div>
                <p><span><strong></strong></span>texte concernant la demande </p>
            </div>
        </div>
           <div class="col-md-10"  >
                <form id="main-contact-form" name="contact-form" method="post" action="{{route('/sendInfo',[$prod['idProduit']])}}">
                {{ csrf_field() }}
                    <div class="row">
