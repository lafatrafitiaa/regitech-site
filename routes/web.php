...
Route::post("/notif/annuler", [NotificationController::class, 'cancelProduit']);
Route::post("/notif/confirmerDevis", [NotificationController::class, 'confirmerDevis']);
...
Route::post("/rdv/report", [RendezvousController::class, 'reportRdv']);
